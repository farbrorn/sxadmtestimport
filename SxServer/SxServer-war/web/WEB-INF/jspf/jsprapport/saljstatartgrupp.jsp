...
" where f1.lagernr = ? and year(f1.datum) between ? and ?  " +
...
%>
				...
				Rappporten visar försäljningsstatistik per artikelgrupp för <%= lagerNamn %> utan att räkna med försäljning från andra filialer.
				<table id="doclist">
					<tr>
						<th>År</th>
