<%-- 
    ...
    Created on : 2009-jul-27, 14:53:42
    Author     : ulf
--%>
<%--
...
" from faktura1 f1 join faktura2 f2 on f1.faktnr = f2.faktnr left outer join artikel a on a.nummer=f2.artnr, fuppg fu " +
" where a.lev = ? and year(f1.datum) between ? and ? " +
...
" order by  year(f1.datum) desc, month(f1.datum) "
	...
	%>
				<h1>Försäljning för Stiebel Eltron</h1>
				Rappporten visar försäljningsstatistik för leverantör STE
				<table id="doclist">
					<tr>
						<th>År</th>
