...
public class RequestHandler {
	...
	public static final String sxconnection = "sxConnection";
	...
	public static Connection getSxConnection(HttpServletRequest req) { return (Connection)req.getAttribute(sxconnection); }
	...
	public static void setSxConnection(HttpServletRequest req, Connection v) { req.setAttribute(sxconnection, v); }
