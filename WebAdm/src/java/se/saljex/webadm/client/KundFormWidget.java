...
import se.saljex.webadm.client.common.FormTimeTextBox;
...
public class KundFormWidget extends TableFormWidget<Kund> {
	...
	private FormTextBox nummer = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.nummer = nummer.getSQLTableValue();}
		@Override	public void set(Kund table) {	nummer.setSQLTableValue(table.nummer);	}
	});
	private FormTextBox namn = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.namn = namn.getSQLTableValue();}
		@Override	public void set(Kund table) {	namn.setSQLTableValue(table.namn);	}
	});
	private FormTextBox adr1 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.adr1 = adr1.getSQLTableValue();}
		@Override	public void set(Kund table) {	adr1.setSQLTableValue(table.adr1);	}

	});
	private FormTextBox adr2 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.adr2 = adr2.getSQLTableValue();}
		@Override	public void set(Kund table) {	adr2.setSQLTableValue(table.adr2);	}
	});
	private FormTextBox adr3 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.adr3 = adr3.getSQLTableValue();}
		@Override	public void set(Kund table) {	adr3.setSQLTableValue(table.adr3);	}
	});
	private FormTextBox lnamn = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.lnamn = lnamn.getSQLTableValue();}
		@Override	public void set(Kund table) {	lnamn.setSQLTableValue(table.lnamn);	}
	});
	private FormTextBox ladr2 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ladr2 = ladr2.getSQLTableValue();}
		@Override	public void set(Kund table) {	ladr2.setSQLTableValue(table.ladr2);	}
	});
	private FormTextBox ladr3 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ladr3 = ladr3.getSQLTableValue();}
		@Override	public void set(Kund table) {	ladr3.setSQLTableValue(table.ladr3);	}
	});
	private FormTextBox ref = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ref = ref.getSQLTableValue();}
		@Override	public void set(Kund table) {	ref.setSQLTableValue(table.ref);	}
	});
	private FormTextBox saljare = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.saljare = saljare.getSQLTableValue();}
		@Override	public void set(Kund table) {	saljare.setSQLTableValue(table.saljare);	}
	});
	private FormTextBox tel = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.tel = tel.getSQLTableValue();}
		@Override	public void set(Kund table) {	tel.setSQLTableValue(table.tel);	}
	});
	private FormTextBox biltel = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.biltel = biltel.getSQLTableValue();}
		@Override	public void set(Kund table) {	biltel.setSQLTableValue(table.biltel);	}
	});
	private FormTextBox fax = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.fax = fax.getSQLTableValue();}
		@Override	public void set(Kund table) {	fax.setSQLTableValue(table.fax);	}
	});
	private FormTextBox sokare = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.sokare = sokare.getSQLTableValue();}
		@Override	public void set(Kund table) {	sokare.setSQLTableValue(table.sokare);	}
	});
	private FormTextBox email = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.email = email.getSQLTableValue();}
		@Override	public void set(Kund table) {	email.setSQLTableValue(table.email);	}
	});
	private FormTextBox hemsida = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.hemsida = hemsida.getSQLTableValue();}
		@Override	public void set(Kund table) {	hemsida.setSQLTableValue(table.hemsida);	}
	});
	private FormIntegerTextBox kDag = new FormIntegerTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.k_Dag = kDag.getSQLTableValue();}
		@Override	public void set(Kund table) {	kDag.setSQLTableValue(table.k_Dag);	}
	});
	private FormTimeTextBox kTid = new FormTimeTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.k_Tid = kTid.getSQLTableValue();}
		@Override	public void set(Kund table) {	kTid.setSQLTableValue(table.k_Tid);	}
	});
	private FormDateTextBox kDatum = new FormDateTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.k_Datum = kDatum.getSQLTableValue();}
		@Override	public void set(Kund table) {	kDatum.setSQLTableValue(table.k_Datum);	}
	});
	private FormTextBox regnr = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.regnr = regnr.getSQLTableValue();}
		@Override	public void set(Kund table) {	regnr.setSQLTableValue(table.regnr);	}
	});
	private FormCheckBox rantfakt = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.rantfakt = rantfakt.getSQLTableValue();}
		@Override	public void set(Kund table) {	rantfakt.setSQLTableValue(table.rantfakt);	}
	});
	private FormCheckBox faktor = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.faktor = faktor.getSQLTableValue();}
		@Override	public void set(Kund table) {	faktor.setSQLTableValue(table.faktor);	}
	});
	private FormDoubleTextBox kgrans = new FormDoubleTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.kgrans = kgrans.getSQLTableValue();}
		@Override	public void set(Kund table) {	kgrans.setSQLTableValue(table.kgrans);	}
	});
	private FormIntegerTextBox ktid = new FormIntegerTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ktid = ktid.getSQLTableValue().shortValue();}
		@Override	public void set(Kund table) {	ktid.setSQLTableValue(new Integer(table.ktid));	}
	});
	private FormTextBox nettolst = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.nettolst = nettolst.getSQLTableValue();}
		@Override	public void set(Kund table) {	nettolst.setSQLTableValue(table.nettolst);	}
	});
	private FormIntegerTextBox bonus = new FormIntegerTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.bonus = bonus.getSQLTableValue().shortValue();}
		@Override	public void set(Kund table) {	bonus.setSQLTableValue(new Integer(table.bonus));	}
	});
	private FormCheckBox elkund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.elkund = elkund.getSQLTableValue();}
		@Override	public void set(Kund table) {	elkund.setSQLTableValue(table.elkund);	}
	});
	private FormCheckBox vvskund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.vvskund = vvskund.getSQLTableValue();}
		@Override	public void set(Kund table) {	vvskund.setSQLTableValue(table.vvskund);	}
	});
	private FormCheckBox ovrigkund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ovrigkund = ovrigkund.getSQLTableValue();}
		@Override	public void set(Kund table) {	ovrigkund.setSQLTableValue(table.ovrigkund);	}
	});
	private FormCheckBox installator = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.installator = installator.getSQLTableValue();}
		@Override	public void set(Kund table) {	installator.setSQLTableValue(table.installator);	}
	});
	private FormCheckBox butik = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.butik = butik.getSQLTableValue();}
		@Override	public void set(Kund table) {	butik.setSQLTableValue(table.butik);	}
	});
	private FormCheckBox industri = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.industri = industri.getSQLTableValue();}
		@Override	public void set(Kund table) {	industri.setSQLTableValue(table.industri);	}
	});
	private FormCheckBox oem = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.oem = oem.getSQLTableValue();}
		@Override	public void set(Kund table) {	oem.setSQLTableValue(table.oem);	}
	});
	private FormCheckBox grossist = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.grossist = grossist.getSQLTableValue();}
		@Override	public void set(Kund table) {	grossist.setSQLTableValue(table.grossist);	}
	});
	private FormTextBox levvillkor = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.levvillkor = levvillkor.getSQLTableValue();}
		@Override	public void set(Kund table) {	levvillkor.setSQLTableValue(table.levvillkor);	}
	});
	private FormCheckBox mottagarfrakt = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.mottagarfrakt = mottagarfrakt.getSQLTableValue();}
		@Override	public void set(Kund table) {	mottagarfrakt.setSQLTableValue(table.mottagarfrakt);	}
	});
	private FormTextBox fraktbolag = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.fraktbolag = fraktbolag.getSQLTableValue();}
		@Override	public void set(Kund table) {	fraktbolag.setSQLTableValue(table.fraktbolag);	}
	});
	private FormTextBox fraktkundnr = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.fraktkundnr = fraktkundnr.getSQLTableValue();}
		@Override	public void set(Kund table) {	fraktkundnr.setSQLTableValue(table.fraktkundnr);	}
	});
	private FormDoubleTextBox fraktfrigrans = new FormDoubleTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.fraktfrigrans = fraktfrigrans.getSQLTableValue();}
		@Override	public void set(Kund table) {	fraktfrigrans.setSQLTableValue(table.fraktfrigrans);	}
	});
	private FormTextBox ant1 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ant1 = ant1.getSQLTableValue();}
		@Override	public void set(Kund table) {	ant1.setSQLTableValue(table.ant1);	}
	});
	private FormTextBox ant2 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ant2 = ant2.getSQLTableValue();}
		@Override	public void set(Kund table) {	ant2.setSQLTableValue(table.ant2);	}
	});
	private FormTextBox ant3 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ant3 = ant3.getSQLTableValue();}
		@Override	public void set(Kund table) {	ant3.setSQLTableValue(table.ant3);	}
	});
	private FormIntegerTextBox distrikt = new FormIntegerTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.distrikt = distrikt.getSQLTableValue().shortValue();}
		@Override	public void set(Kund table) {	distrikt.setSQLTableValue(new Integer(table.distrikt));	}
	});
	private FormCheckBox vakund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.vakund = vakund.getSQLTableValue();}
		@Override	public void set(Kund table) {	vakund.setSQLTableValue(table.vakund);	}
	});
	private FormCheckBox fastighetskund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.fastighetskund = fastighetskund.getSQLTableValue();}
		@Override	public void set(Kund table) {	fastighetskund.setSQLTableValue(table.fastighetskund);	}
	});
	private FormDoubleTextBox basrab = new FormDoubleTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.basrab = basrab.getSQLTableValue();}
		@Override	public void set(Kund table) {	basrab.setSQLTableValue(table.basrab);	}
	});
	private FormCheckBox golvkund = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.golvkund = golvkund.getSQLTableValue();}
		@Override	public void set(Kund table) {	golvkund.setSQLTableValue(table.golvkund);	}
	});
	private FormCheckBox ejfakturerbar = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.ejfakturerbar = ejfakturerbar.getSQLTableValue();}
		@Override	public void set(Kund table) {	ejfakturerbar.setSQLTableValue(table.ejfakturerbar);	}
	});
	private FormCheckBox skrivfakturarskenr = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.skrivfakturarskenr = skrivfakturarskenr.getSQLTableValue();}
		@Override	public void set(Kund table) {	skrivfakturarskenr.setSQLTableValue(table.skrivfakturarskenr);	}
	});
	private FormCheckBox sarfaktura = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.sarfaktura = sarfaktura.getSQLTableValue();}
		@Override	public void set(Kund table) {	sarfaktura.setSQLTableValue(table.sarfaktura);	}
	});
	private FormCheckBox momsfri = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.momsfri = momsfri.getSQLTableValue();}
		@Override	public void set(Kund table) {	momsfri.setSQLTableValue(table.momsfri);	}
	});
	private FormDoubleTextBox kgransforfall30 = new FormDoubleTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.kgransforfall30 = kgransforfall30.getSQLTableValue();}
		@Override	public void set(Kund table) {	kgransforfall30.setSQLTableValue(table.kgransforfall30);	}
	});
	private FormCheckBox kravordermarke = new FormCheckBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.kravordermarke = kravordermarke.getSQLTableValue();}
		@Override	public void set(Kund table) {	kravordermarke.setSQLTableValue(table.kravordermarke);	}
	});
	private FormTextBox linjenr1 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.linjenr1 = linjenr1.getSQLTableValue();}
		@Override	public void set(Kund table) {	linjenr1.setSQLTableValue(table.linjenr1);	}
	});
	private FormTextBox linjenr2 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.linjenr2 = linjenr2.getSQLTableValue();}
		@Override	public void set(Kund table) {	linjenr2.setSQLTableValue(table.linjenr2);	}
	});
	private FormTextBox linjenr3 = new FormTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.linjenr3 = linjenr3.getSQLTableValue();}
		@Override	public void set(Kund table) {	linjenr3.setSQLTableValue(table.linjenr3);	}
	});
	private FormCheckBox skickafakturaepost = new FormCheckBox("Skicka faktura som e-post", new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.skickafakturaepost = skickafakturaepost.getSQLTableValue();}
		@Override	public void set(Kund table) {	skickafakturaepost.setSQLTableValue(table.skickafakturaepost);	}
	});
	private FormDoubleTextBox samfakgrans = new FormDoubleTextBox(new FormWidgetGetSet<Kund>() {
		@Override	public void get(Kund table) {	table.samfakgrans = samfakgrans.getSQLTableValue();}
		@Override	public void set(Kund table) {	samfakgrans.setSQLTableValue(table.samfakgrans);	}
	});
