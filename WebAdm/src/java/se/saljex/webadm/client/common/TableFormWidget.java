...
import se.saljex.webadm.client.SaveTableRowButton;
import se.saljex.webadm.client.SaveTableRowButtonHandler;
import se.saljex.webadm.client.commmon.constants.KeyCodes;
...
public abstract class TableFormWidget<T extends IsSQLTable> extends FlowPanel implements HasFormUpdater<T>{
	...
	protected FormInputPanel<T> focusForm = new FormInputPanel();
