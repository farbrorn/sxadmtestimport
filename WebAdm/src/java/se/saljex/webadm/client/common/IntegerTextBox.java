 ...
 * </p>
 */
public class IntegerTextBox extends ValueBox<Integer> {
  ...
  public static IntegerTextBox wrap(Element element) {
    // Assert that the element is attached.
    assert Document.get().getBody().isOrHasChild(element);

    IntegerTextBox textBox = new IntegerTextBox(element);
   ...
   */
  protected IntegerTextBox(Element element) {
    super(element, IntegerRenderer.instance(), IntegerParser.instance());
	addKeyPressHandler(new KeyPressHandler() {
			...
			public void onKeyPress(KeyPressEvent event) {
				...
				Integer pValue=null;
				try {
					pValue = ((IntegerTextBox)event.getSource()).getValueOrThrow();
  ...
  IntegerTextBox(Element element, String styleName) {
    this(element);
    if (styleName != null) {
