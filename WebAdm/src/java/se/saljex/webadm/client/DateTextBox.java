 ...
 * </p>
 */
public class DateTextBox extends ValueBox<Date> {
  ...
  public static DateTextBox wrap(Element element) {
    // Assert that the element is attached.
    assert Document.get().getBody().isOrHasChild(element);

    DateTextBox textBox = new DateTextBox(element);
   ...
   */
  protected DateTextBox(Element element) {
    super(element, new DateTimeFormatRenderer(DateTimeFormat.getFormat("yyyy-MM-dd")), new DateTimeParser(DateTimeFormat.getFormat("yyyy-MM-dd")));
    assert InputElement.as(element).getType().equalsIgnoreCase("text");
  }

  DateTextBox(Element element, String styleName) {
    this(element);
    if (styleName != null) {
