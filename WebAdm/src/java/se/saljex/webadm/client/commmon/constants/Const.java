...
package se.saljex.webadm.client.commmon.constants;
...
public static final String Style_TextSmall = "sx-text-small";
public static final String Style_TextSmaller = "sx-text-smaller";
public static final String Style_TextMedium  = "sx-text-medium";
public static final String Style_TextLarge = "sx-text-large";
public static final String Style_TextLarger = "sx-text-larger";

public static final String Style_ErrorLabel="sx-errorlabel";
